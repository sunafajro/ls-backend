...
/* @var $model school\models\CalcPhonebook */

$this->title = 'Система учета :: ' . Yii::t('app','Update phone') . ' / ' . ' ' . $model->name;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'References'), 'url' => ['reference/phonebook']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Phones'), 'url' => ['reference/phonebook']];
$this->params['breadcrumbs'][] = Yii::t('app', 'Update');
?>
<div class="row row-offcanvas row-offcanvas-left phonebook-update">
