...
$canChangePassword = AccessRule::checkAccess('rule.user.change-password.any') || $auth->id === $user->id;
...
$canUploadImage = AccessRule::checkAccess('rule.user.upload-image.any') || $auth->id === $user->id;
$canDeleteImage = AccessRule::checkAccess('rule.user.delete-image.any') || $auth->id === $user->id;
$canTimeTracking = AccessRule::checkAccess('rule.time-tracking.manage.any') || $auth->id === $user->id;
