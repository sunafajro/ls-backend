...
/* @var $model school\models\Timenorm */

$this->title = 'Система учета :: ' . Yii::t('app', 'Update time norm') . ' / ' . ' ' . $model->name;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'References'), 'url' => ['reference/phonebook']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Time norms'), 'url' => ['reference/timenorm']];
$this->params['breadcrumbs'][] = Yii::t('app', 'Update');
?>
<div class="row row-offcanvas row-offcanvas-left timenorm-update">
