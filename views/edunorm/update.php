...
/* @var $model app\models\Edunorm */

$this->title = 'Система учета :: ' . Yii::t('app', 'Update teacher norm') . ' / ' . ' ' . $model->name;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'References'), 'url' => ['reference/phonebook']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Teacher norms'), 'url' => ['reference/teachpaynorm']];
$this->params['breadcrumbs'][] = Yii::t('app', 'Update');
?>
<div class="row row-offcanvas row-offcanvas-left teachpaynorm-update">
