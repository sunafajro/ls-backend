...
_reactDom2.default.render(_react2.default.createElement(_App2.default, null), document.getElementById('app-invoice'));
...
var SID = document.getElementById('app-invoice').dataset.sid;
...
var App = function (_Component) {
  ...
  function App() {
    ...
    }, _this.getData = function (sid) {
      _this.setState({ fetchingData: true });
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'col-sm-12' },
        this.state.fetchingData ? _react2.default.createElement(
          'div',
        ...
        ) : this.state.fetchingDataError ? _react2.default.createElement(
          'div',
          ...
          'div',
          { className: 'row row-offcanvas row-offcanvas-left invoice-create' },
...
var _UserBlock = __webpack_require__(33);
...
var SideBar = function (_Component) {
  ...
  _createClass(SideBar, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'sidebar', className: 'col-xs-6 col-sm-2 sidebar-offcanvas' },
        _react2.default.createElement(_UserBlock2.default, { user: this.props.user }),
        this.props.hints.length ? _react2.default.createElement(
          'ul',
          null,
          this.props.hints.map(function (item, i) {
            return _react2.default.createElement(
              'li',
              { key: 'hint_' + i },
              item
...
SideBar.propTypes = {
  ...
  hints: _propTypes2.default.array.isRequired
};
...
var UserBlock = function (_Component) {
  _inherits(UserBlock, _Component);

  function UserBlock() {
    _classCallCheck(this, UserBlock);

    return _possibleConstructorReturn(this, (UserBlock.__proto__ || Object.getPrototypeOf(UserBlock)).apply(this, arguments));
  }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.user.teacherId ? _react2.default.createElement('a', {
        ...
        this.props.user.office ? _react2.default.createElement(
          'p',
          { style: { margin: 0 } },
...
var Content = function (_Component) {
  ...
  function Content() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Content.__proto__ || Object.getPrototypeOf(Content)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      sending: false,
      saveResult: null
    }, _this.calcInvoiceSum = function () {
      var totalValue = 0;
      var totalWithSale = 0;
      var totalSale = 0;
      var serviceVal = _this.state.serviceId !== "0" ? _this.getServiceValue(_this.state.serviceId) : null;
      var procSaleVal = _this.state.procsaleId !== "0" ? _this.getProcSaleValue(_this.state.procsaleId) : null;
      var rubSaleVal = _this.state.rubsaleId !== "0" ? _this.getRubSaleValue(_this.state.rubsaleId) : null;

      /* считаем полную стоимость без скидок */
      totalValue = _this.state.lessonNum * serviceVal;
      totalWithSale = totalValue;

      if (rubSaleVal) {
        /* вычитаем рублевую назначенную скидку */
        totalWithSale = totalWithSale - rubSaleVal;
      } else if (_this.state.rubsaleValue) {
        /* или вычитаем рублевую введеную скидку */
        totalWithSale = totalWithSale - _this.state.rubsaleValue;
      }

      if (procSaleVal) {
        /* вычитаем процентную назначенную скидку */
        totalWithSale = totalWithSale - totalWithSale * procSaleVal * 0.01;
      } else if (_this.state.permsaleId !== "0") {
        /* вычитаем процентную постоянную скидку */
        totalWithSale = totalWithSale - totalWithSale * _this.props.permsale.value * 0.01;
      }
    ...
    }, _this.getServiceValue = function (id) {
      var value = void 0;

      _this.props.services.forEach(function (item) {
        if (item.id === id) {
      ...
      return value;
    }, _this.getProcSaleValue = function (id) {
      var value = void 0;

      _this.props.procsales.forEach(function (item) {
        if (item.id === id) {
          value = parseFloat(item.value).toFixed(2);
        }
      });
      ...
      return value;
    }, _this.getRubSaleValue = function (id) {
      var value = void 0;

      _this.props.rubsales.forEach(function (item) {
        if (item.id === id) {
          value = parseFloat(item.value).toFixed(2);
        }
      });
      ...
      var valid = true;
      var validation = _extends({}, _this.state.validation);

      if (_this.state.serviceId === "0") {
        valid = false;
      ...
      if (_this.state.rubsaleValue !== 0) {
        if (!_this.state.salePurpose) {
          valid = false;
      ...
      if (_this.props.offices.length && _this.state.officeId === "0") {
        valid = false;
      ...
      if (_this.validateForm()) {
        var _this$calcInvoiceSum = _this.calcInvoiceSum(),
            totalSum = _this$calcInvoiceSum.totalSum,
            totalSumWithSale = _this$calcInvoiceSum.totalSumWithSale,
            totalSale = _this$calcInvoiceSum.totalSale;

        var validation = _this.resetValidation();

        _this.setState({
          sending: true,
          totalSum: totalSum,
          totalSumWithSale: totalSumWithSale,
          totalSale: totalSale,
        ...
        var body = JSON.stringify({
          Invoicestud: {
            sid: _this.props.sid,
            service: _this.state.serviceId,
            procsale: _this.state.procsaleId,
            rubsaleid: _this.state.rubsaleId,
            rubsalesval: _this.state.rubsaleValue,
            permsale: _this.state.permsaleId,
            num: _this.state.lessonNum,
            office: _this.state.officeId,
            remain: _this.state.remain ? "1" : "0",
            invoiceValue: totalSumWithSale,
            invoiceDiscount: totalSale,
            salePurpose: _this.state.salePurpose
          }
        });
        fetch("/invoice/create", {
          ...
          if (response.ok) {
            ...
            var timer = setTimeout(function () {
              window.location.replace("/studname/view?id=" + _this.props.sid);
            }, 2000);
          } else {
      ...
      var _this$calcInvoiceSum2 = _this.calcInvoiceSum(),
          totalSum = _this$calcInvoiceSum2.totalSum,
          totalSumWithSale = _this$calcInvoiceSum2.totalSumWithSale,
          totalSale = _this$calcInvoiceSum2.totalSale;
    ...
    }, _this.resetValidation = function () {
      var validation = _extends({}, _this.state.validation);
  ...
  _createClass(Content, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          permsale = _props.permsale,
          procsales = _props.procsales,
          rubsales = _props.rubsales;

      return _react2.default.createElement(
        "div",
        { id: "content", className: "col-sm-6" },
        _react2.default.createElement(
          "p",
        ...
        sending ? _react2.default.createElement(
          "div",
          { className: "alert alert-warning" },
          labels.sendingMessage
        ) : this.state.saveResult === null ? _react2.default.createElement(
          "div",
          ...
          " ",
          Math.abs(this.state.totalSale),
          " \u0440. = ",
          this.state.totalSumWithSale,
          " ",
          "\u0440."
        ) : this.state.saveResult !== true ? _react2.default.createElement(
          "div",
          { className: "alert alert-danger" },
          labels.saveErrorMessage
        ) : _react2.default.createElement(
          "div",
          { className: "alert alert-success" },
          labels.saveSuccessMessage
        ),
        _react2.default.createElement(
          "div",
          null,
          this.props.services.length ? _react2.default.createElement(
            "div",
            {
              className: validation.service === null ? "form-group" : validation.service !== true ? "form-group has-error" : "form-group has-success"
            },
            _react2.default.createElement(
              "label",
              {
            ...
            _react2.default.createElement(
              "select",
              {
                ...
                onChange: function onChange(e) {
                  return _this2.setState({ serviceId: e.target.value });
                }
              },
              _react2.default.createElement(
                "option",
              ...
              this.props.services.map(function (item) {
                return _react2.default.createElement(
                  "option",
                  { key: "service_" + item.id, value: item.id },
                  "#",
                  item.id,
                  " ",
                  item.name,
          ...
          _react2.default.createElement(
            "div",
            { className: "row" },
            procsales.length ? _react2.default.createElement(
              "div",
              { className: permsale.id ? "col-sm-6" : "col-sm-12" },
              _react2.default.createElement(
                "div",
                ...
                _react2.default.createElement(
                  ...
                  procsales.map(function (item) {
                    return _react2.default.createElement(
                      "option",
                      { key: "procsale_" + item.id, value: item.id },
                      item.name
                    );
                  })
                )
            ...
            permsale.id ? _react2.default.createElement(
              "div",
              { className: procsales.length ? "col-sm-6" : "col-sm-12" },
              _react2.default.createElement(
                "div",
                { className: "form-group" },
                _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "row" },
            rubsales.length ? _react2.default.createElement(
              "div",
              { className: "col-sm-6" },
              _react2.default.createElement(
                "div",
                ...
                _react2.default.createElement(
                  ...
                  rubsales.map(function (item) {
                    return _react2.default.createElement(
                      "option",
                      { key: "rubsale_" + item.id, value: item.id },
                      item.name
                    );
                  })
                )
            ...
            _react2.default.createElement(
              "div",
              { className: rubsales.length ? "col-sm-6" : "col-sm-12" },
              _react2.default.createElement(
                "div",
                { className: "form-group" },
                _react2.default.createElement(
          ...
          this.state.rubsaleValue !== 0 ? _react2.default.createElement(
            "div",
            { className: "row" },
            _react2.default.createElement(
              "div",
              ...
              _react2.default.createElement(
                "div",
                {
                  className: validation.purpose === null ? "form-group" : validation.purpose !== true ? "form-group has-error" : "form-group has-success"
                },
                _react2.default.createElement(
                  "label",
                  {
          ...
          _react2.default.createElement(
            "div",
            {
              className: validation.num === null ? "form-group" : validation.num !== true ? "form-group has-error" : "form-group has-success"
            },
            _react2.default.createElement(
              "label",
              { className: "control-label", htmlFor: "invoicestud-num" },
              labels.num,
              ":"
            ),
            _react2.default.createElement("input", {
              ...
              onChange: function onChange(e) {
                return _this2.setState({
                  lessonNum: parseInt(e.target.value) >= 0 ? parseInt(e.target.value) : 0
                });
              }
            })
          ),
          offices.length ? _react2.default.createElement(
            "div",
            {
              className: validation.office === null ? "form-group" : validation.office !== true ? "form-group has-error" : "form-group has-success"
            },
            _react2.default.createElement(
              "label",
              {
            ...
            _react2.default.createElement(
              "select",
              {
                ...
                onChange: function onChange(e) {
                  return _this2.setState({ officeId: e.target.value });
                }
              },
              _react2.default.createElement(
                "option",
              ...
              offices.map(function (item) {
                return _react2.default.createElement(
                  "option",
                  { key: "office_" + item.id, value: item.id },
                  item.name
                );
              })
            )
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement("input", {
                  ...
                  onChange: function onChange(e) {
                    return _this2.setState({ remain: e.target.checked });
                  }
                }),
                " ",
                labels.remain
...
Content.propTypes = {
  sid: _propTypes2.default.string.isRequired,
  services: _propTypes2.default.array.isRequired,
  rubsales: _propTypes2.default.array.isRequired,
  procsales: _propTypes2.default.array.isRequired,
  offices: _propTypes2.default.array.isRequired,
  permsale: _propTypes2.default.object.isRequired,
